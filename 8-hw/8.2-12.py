...
class Container(Box):
    ...
    def open(self):
        return f"В ящике размером {self.size} и весом {self.weight} оказалось {self.contains}"


box_1 = Box("30x30", "1кг", "15 золотых монет")

container_1 = Container("50x30", "2кг", "7 золотых монет")
